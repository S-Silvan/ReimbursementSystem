...
<head>
    ...
    <title>Pending reimbursement request</title>
...
<body>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="/ReimbursementSystem/view-employee-pending-reimbursement-requests">Pending request</a>
                                </li>
                                <li class="nav-item">
    ...
    <section class="container mt-4">
        <table class="table table-bordered">
            ...
            <tbody>
            	<%
            		List<ReimbursementRequest> reimbursementRequestList=(List<ReimbursementRequest>)request.getAttribute("pendingReimbursementRequests");
